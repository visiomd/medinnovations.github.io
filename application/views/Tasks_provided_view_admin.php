    ...
    <div class="panel-heading">
        ...
        <div class="panel-body">
            ...
            $attr = array('class' => 'form-horizontal',
                       'role' => 'form');
            echo form_open('Tasks/changePrice/'.$t['id'], $attr); 
            ?>
            <div class="form-group mt-20">
                <div class="col-xs-6 col-md-4">
                <?php if($t['cost'] === null): ?>
                <h4>Цена не указана</h4>
                <?php else: ?>
                <h4>Цена: <?= $t['cost']; ?></h4>
                <?php endif;?>
                </div>
            ...
            <?php 
                ...
                echo form_submit('submit', 'Изменить цену', $attr); 
            ?>
                </div>
            </div>
            <?= form_close(); ?>
            <?php $attr = array('class' => 'form-horizontal',
                                 'role' => 'form');
                echo form_open('http://medinnovations.ru/Tasks/addModeratorData/'.$t['id'], $attr); 
            ?>
            <div class="form-group mt-20">
                <div class="col-xs-6 col-md-4">
                <?php if($t['doctor'] === null): ?>
                <h4>Id врача не указан</h4>
                <?php else: ?>
                <h4>ID врача - [<?= $t['doctor']; ?>]</h4>
                <?php endif;?>    
                </div> 
                <div class="col-xs-6 col-md-4">
                <?php
                  $attr = array ('placeholder' => '**Код врача',
                                 'id'          => 'name',
                                 'class'       => 'form-control');
                  echo form_input('Doctor', set_value('Doctor'), $attr);
                ?>
                </div>
                <div class="col-xs-6 col-md-4">
                <?php $attr = array('class' => 'btn btn-primary'); 
                    echo form_submit('submit', 'Изменить id', $attr); 
                ?>
                </div>
            </div>
            <?= form_close(); ?>
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:99%">100%</div>
            </div>   
            <?php else: ?>
            <?php endif;?>
            </div>
            <div class="mt-20" style='text-align: center; font-weight: bold;'>
