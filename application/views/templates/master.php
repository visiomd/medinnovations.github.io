    ...
    <nav class="teal lighten-4">
      <div id="nabBarEl" class="nav-wrapper">
        ...
        <?php if($content === 'Main_index_view'):?>
           <li class="tab"><a id="blinkAboutPage" href="#">О нас</a></li>
           <li class="tab"><a id="blinkSamplePage" href="#">Примеры работ</a></li>
           <li class="tab"><a id="blinkContactPage" href="#">Контакты</a></li>
        <?php endif; ?>
...
<script type="text/javascript" src="https://api.trello.com/1/client.js?key=d7d7a689ea01ebd8e691cde9d145383d"></script>
<?php endif; ?>
<?php if(isset($js)): ?>
